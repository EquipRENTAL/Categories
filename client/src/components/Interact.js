...
------------------------------------------------------------------------------------------------------ */}
        <div className="col-1">
            ...
            {/* <button type="button" className="btn btn-primary" id="confirm-btn" data-toggle="modal" data-target="#inquireModal">
                Inquire
            </button> */}

            <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Inquire
            </button>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <form className="needs-validation" novalidate>
                                <div className="form-row">
                                    ...
                                    <div className="col-md-3 mb-3">
                                        ...
                                        <input type="text" className="form-control" id="validationCustom03" placeholder="XXX-XXX-XXX" required>
                                        </input>

                                        <div className="invalid-feedback">Please provide a valid phone number.
                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-3 mb-3">
                                        ...
                                        <input type="text" className="form-control" id="validationCustom04" placeholder="e-mail" required>
                                        </input>
                            ...
                            <form className="needs-validation" novalidate>
                                <div className="form-row">
                                    ...
                                    <div className="col-md-3 mb-3">
                                        ...
                                        <input type="text" className="form-control" id="validationCustom06" placeholder="State" required>
                                        </input>

                                        <div className="invalid-feedback">            Please provide a valid st
                        </div>
                                    </div>

                                    <div className="col-md-3 mb-3">
                                        <label for="validationCustom07">Zip</label>
                                        <input type="text" className="form-control" id="validationCustom07" placeholder="Zip" required>
                                        </input>
                                        <div className="invalid-feedback">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary">Send message to owner</button>
                            </div>
                        </div>
                    </div>
                </div>
...
------------------------------------------------------------------------------------------------------ */}
        ...
        <div className="col-1">
            <button type="button" className="btn btn-primary" id="view-btn" data-toggle="modal" data-target="#exampleModalLong">
                Reviews
            </button>
            ...
            <div className="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header" id="review-modal-title">
                            <h5 className="modal-title" id="exampleModalLongTitle">Buyer/Item Review</h5>
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        {/* <div className="modal-body"> */}
                        <div className="modal-dialog" id="buyer-item-modal">
                            Hello,
...
------------------------------------------------------------------------------------------------------ */}
        ...
        <div className="col-2">
            ...
            <button type="button" className="btn btn-primary" id="confirm-btn" data-toggle="modal" data-target="#confirmModal">
                Confirm
                </button>
            ...
            <div className="modal fade" id="confirmModal" tabindex="1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="confirmModal">Confirm Rental</h5>
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
